...
class MyServer(BaseHTTPRequestHandler):
    def do_GET(self):
        if (self.path == "/metrics"):
            ...
            self.wfile.write(bytes(f"vesync_humidity_ratio{{CID=\"{cid}\"}} {humidifier['Humidity']}\n", "utf-8"))
            ...
            self.wfile.write(bytes(f"vesync_target_humidity_ratio{{CID=\"{cid}\"}} {humidifier['Auto Target Humidity']}\n", "utf-8"))
